...
BEGIN
	...
	@UserRight=UserRight, @MasterRight=MasterRight, @Face=Face, @MemberOrder=MemberOrder, @MemberOverDate=MemberOverDate,
	@TZPoint=TZPoint, @LastLogonDate=LastLogonDate, @LastLogonIP=LastLogonIP
	...
	@MasterRight AS MasterRight,@MemberOrder AS MemberOrder, 
	@TZPoint AS TZPoint, @LastLogonDate AS LastLogonDate, @LastLogonIP AS LastLogonIP

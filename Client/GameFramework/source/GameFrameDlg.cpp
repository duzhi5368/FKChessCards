...
//自己桌子
WORD CGameFrameDlg::GetMeTableID()
{
	if (m_ClientKernelHelper.GetInterface()==NULL) return INVALID_CHAIR;
	return m_ClientKernelHelper->GetMeTableID();
}
...
BOOL CGameFrameDlg::OnInitDialog()
{
	...
	//m_GameVideo.Init( 2, this );
	//m_GameVideo.SetWindowPos( 0, 100,100,156, 145 ) ;
	//m_GameVideo.SetWindowPos( 1, 300,100,156, 145 ) ;
	...
	//m_GameVideo.ShowWindow(SW_SHOW);
	//m_GameVideo.Login( "222.223.65.99", 8001, 1, 1, 1 );


	//WORD pos = GetMeChairID();

	////初始化视频
 //	m_GameVideo.Init( 8, this );
	//m_GameVideo.SetWindowPos( 0, 100, 300, 156, 145 );
	//m_GameVideo.SetWindowPos( 1, 500, 100, 156, 145 );
	//m_GameVideo.SetWindowPos( 2, 900, 300, 156, 145 );
	...
	//m_GameVideo.ShowWindow( SW_SHOW, 0 );
	//m_GameVideo.ShowWindow( SW_SHOW, 1 );
	//m_GameVideo.ShowWindow( SW_SHOW, 2 );


	//m_GameVideo.Login( "222.223.65.99", 8001, 1, 1, pos+1 );
...
void CGameFrameDlg::OnCancel()
{
	...
	//m_GameVideo.m_pVideoClient->Enable( false );
	//m_GameVideo.Release() ;

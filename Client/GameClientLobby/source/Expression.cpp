...
bool CExpression::InitExpressItem()
{
	...
	{
		//设置资源
		AfxSetResourceHandle(GetModuleHandle(GAMECLIENTLOBBY_EXPORTS_NAME));
		...
		m_ExpreesionItem[70].InitExpressItem(TEXT(""),TEXT("/:71"),IDB_EP_071);
		m_ExpreesionItem[71].InitExpressItem(TEXT(""),TEXT("/:72"),IDB_EP_072);
		m_ExpreesionItem[72].InitExpressItem(TEXT(""),TEXT("/:73"),IDB_EP_073);
		m_ExpreesionItem[73].InitExpressItem(TEXT(""),TEXT("/:74"),IDB_EP_074);
		m_ExpreesionItem[74].InitExpressItem(TEXT(""),TEXT("/:75"),IDB_EP_075);
		m_ExpreesionItem[75].InitExpressItem(TEXT(""),TEXT("/:76"),IDB_EP_076);
		m_ExpreesionItem[76].InitExpressItem(TEXT(""),TEXT("/:77"),IDB_EP_077);
		m_ExpreesionItem[77].InitExpressItem(TEXT(""),TEXT("/:78"),IDB_EP_078);
		m_ExpreesionItem[78].InitExpressItem(TEXT(""),TEXT("/:79"),IDB_EP_079);
		m_ExpreesionItem[79].InitExpressItem(TEXT(""),TEXT("/:80"),IDB_EP_080);

		m_ExpreesionItem[80].InitExpressItem(TEXT(""),TEXT("/:81"),IDB_EP_081);
		m_ExpreesionItem[81].InitExpressItem(TEXT(""),TEXT("/:82"),IDB_EP_082);
		m_ExpreesionItem[82].InitExpressItem(TEXT(""),TEXT("/:83"),IDB_EP_083);
		m_ExpreesionItem[83].InitExpressItem(TEXT(""),TEXT("/:84"),IDB_EP_084);
		m_ExpreesionItem[84].InitExpressItem(TEXT(""),TEXT("/:85"),IDB_EP_085);
		m_ExpreesionItem[85].InitExpressItem(TEXT(""),TEXT("/:86"),IDB_EP_086);
		//设置资源

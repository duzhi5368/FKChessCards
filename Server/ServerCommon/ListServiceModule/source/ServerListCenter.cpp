...
#include "../Include/ServerListCenter.h"
...
bool __cdecl CServerListCenter::LoadServerList(tagDataBaseInfo & DataBaseInfo)
{
	...
	try
	{
		...
		//连接数据库
		ServerInfoDB->SetConnectionInfo(szDataBaseAdr,DataBaseInfo.szDataBaseName,DataBaseInfo.szDataBaseUser,DataBaseInfo.szDataBasePass);

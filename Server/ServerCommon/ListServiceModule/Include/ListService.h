...
#include "../../../ServerCommon/CoreServer/include/ServerKernel.h"

//////////////////////////////////////////////////////////////////////////
//公共宏定义

//导出定义
#ifndef LIST_SERVER_MODULE_CLASS
	#ifdef  LISTSERVERMODULE_EXPORTS
		#define LIST_SERVER_MODULE_CLASS _declspec(dllexport)
	#else
		#define LIST_SERVER_MODULE_CLASS _declspec(dllimport)
	#endif
#endif

//模块定义
#ifdef _DEBUG
	#define LIST_SERVER_MODULE_NAME	TEXT("ListServiceModule.dll")				//组件 DLL 名字
#else
	#define LIST_SERVER_MODULE_NAME	TEXT("ListServiceModule.dll")					//组件 DLL 名字
#endif
...
public:
	...
	CServerListCenterHelper(void) : CTempldateHelper<IServerListCenter>(IID_IServerListCenter,
		VER_IServerListCenter,LIST_SERVER_MODULE_NAME,TEXT("CreateServerListCenter")) { }
};

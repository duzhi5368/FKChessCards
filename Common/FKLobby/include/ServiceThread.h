...
//临界区同步类
class FKLOBBY_DLL_CLASS CThreadLock : public IThreadLock
{
	//变量定义
private:
...
//安全同步锁定句柄
class FKLOBBY_DLL_CLASS CThreadLockHandle
{
	//变量定义
private:
...
//线程对象类
class FKLOBBY_DLL_CLASS CServiceThread : public IServiceThread
{
	//变量定义
private:

...
//属性名字
#define FKUIMODULE_CLASS_NAME_STRING		TEXT("类名字")				// TCHAR * 类型 （只读）

//////////////////////////////////////////////////////////////////////////

//属性记录类
class FKUIMODULE_CLASS CSkinRecordFile : public ISkinRecord
{
	//变量定义
protected:
...
//界面属性
class FKUIMODULE_CLASS CSkinAttribute : public ISkinAttribute, public CAttributeManager
{
	//变量定义
protected:
...
public:
	//加载界面信息
	static bool LoadUserInfo(IUnknownEx * pIUnknownEx);
	//保存界面信息

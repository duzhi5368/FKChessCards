...
//对话框类
class FKUIMODULE_CLASS CSkinDialog : public CDialog, public CSkinWndObject
{
	//函数定义
public:
	//构造函数
...
//对话框类
class FKUIMODULE_CLASS CSkinDialogEx : public CSkinDialog
{
	//函数定义
public:
	//构造函数
...
//区域对话框类
class FKUIMODULE_CLASS CRgnDialog : public CDialog
{
	//变量定义
protected:

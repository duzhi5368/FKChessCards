...
#include "../Include/SkinAttribute.h"
...
{ 
	...
	RegisterAttribute(FKUIMODULE_CLASS_NAME_STRING,m_szClassName,true);
...
//加载界面信息
bool CSkinAttribute::LoadUserInfo(IUnknownEx * pIUnknownEx)
{
	//查询接口
	ASSERT(pIUnknownEx!=NULL);

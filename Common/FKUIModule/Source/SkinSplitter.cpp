...
#include "../Resource.h"
#include "../Include/SkinSplitter.h"
...
{
	HINSTANCE hInstance=GetModuleHandle(FKUIMODULE_DLL_NAME);
	m_ImageHor.SetLoadInfo(IDB_SHIN_SPLITTER_HOR,hInstance);
	m_ImageVor.SetLoadInfo(IDB_SHIN_SPLITTER_VOR,hInstance);

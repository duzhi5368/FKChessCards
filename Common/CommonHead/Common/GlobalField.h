...
#define DTP_USER_POINT					209								//用户点券
#define DTP_USER_SCORE					210								//用户分数
#define DTP_USER_PLAY_COUNT				211								//总局盘数
#define DTP_GAME_LEVEL					212								//游戏等级
#define DTP_USER_GOLD					213								//金钱总量
#define DTP_USER_EXPERIENCE				214								//经验总量
#define DTP_USER_GROUP_NAME				215								//工会名称

//扩展信息
#define DTP_USER_NOTE					300								//用户备注
#define DTP_USER_DESCRIBE				301								//用户描述
#define DTP_USER_COMPANION				302								//用户关系

...
//类对象工厂
template <class TYPE> class CFactoryTemplate1
{
	//类说明
...
public:
	//构造函数
	CFactoryTemplate1(void);
	//析构函数
	virtual ~CFactoryTemplate1(void);
...
//////////////////////////////////////////////////////////////////////////
// CFactoryTemplate1<TYPE> 内联函数

//最大数目
template<class TYPE> AFX_INLINE INT_PTR CFactoryTemplate1<TYPE>::GetMaxCount()
{
	return m_nMaxCount;
}

//空闲数目
template<class TYPE> AFX_INLINE INT_PTR CFactoryTemplate1<TYPE>::GetFreeCount()
{
	return m_FreeItem.GetCount();
}

//活动数目
template<class TYPE> AFX_INLINE INT_PTR CFactoryTemplate1<TYPE>::GetActiveCount()
{
	return m_ActiveItem.GetCount();
}

//存储数目
template<class TYPE> AFX_INLINE INT_PTR CFactoryTemplate1<TYPE>::GetStorageCount()
{
	return m_StorageItem.GetCount();
}

//设置数目
template<class TYPE> AFX_INLINE void CFactoryTemplate1<TYPE>::SetMaxCount(INT_PTR nMaxCount)
{
	m_nMaxCount=nMaxCount;
}

//复制空闲
template<class TYPE> AFX_INLINE void CFactoryTemplate1<TYPE>::CopyFreeItem(CItemPtrArray & ItemPtrArray)
{
...
//复制活动
template<class TYPE> AFX_INLINE void CFactoryTemplate1<TYPE>::CopyActiveItem(CItemPtrArray & ItemPtrArray)
{
...
//复制存储
template<class TYPE> AFX_INLINE void CFactoryTemplate1<TYPE>::CopyStorageItem(CItemPtrArray & ItemPtrArray)
{
...
//////////////////////////////////////////////////////////////////////////
// CFactoryTemplate1<TYPE> 外联函数

//构造函数
template<class TYPE> CFactoryTemplate1<TYPE>::CFactoryTemplate1()
{
...
//创建对象
template<class TYPE> TYPE * CFactoryTemplate1<TYPE>::ActiveItem()
{
	//获取空闲对象
	TYPE * pObject=NULL;
...
//删除所有
template<class TYPE> void CFactoryTemplate1<TYPE>::FreeAllItem()
{
...
//释放内存
template<class TYPE> void CFactoryTemplate1<TYPE>::FreeExtra()
{
	TYPE * pObject=NULL;
	for (INT_PTR i=0;i<m_StorageItem.GetCount();i++)
	{
...
//删除对象
template<class TYPE> bool CFactoryTemplate1<TYPE>::FreeItem(TYPE * pObject)
{
	//效验参数
	ASSERT(pObject!=NULL);
...
//枚举对象
template<class TYPE> TYPE * CFactoryTemplate1<TYPE>::EnumActiveObject(INT_PTR nIndex)
{
	//效验参数
	ASSERT(nIndex>=0);
...
//枚举对象
template<class TYPE> TYPE * CFactoryTemplate1<TYPE>::EnumStorageObject(INT_PTR nIndex)
{
	//效验参数
	ASSERT(nIndex>=0);
	if (nIndex<0) return NULL;
